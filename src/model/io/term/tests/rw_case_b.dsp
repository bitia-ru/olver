# Microsoft Developer Studio Project File - Name="rw_case_b" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=rw_case_b - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "rw_case_b.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "rw_case_b.mak" CFG="rw_case_b - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "rw_case_b - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "rw_case_b - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "rw_case_b - Win32 Release"
...
!ELSEIF  "$(CFG)" == "rw_case_b - Win32 Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "rw_case_b___Win32_Debug"
# PROP BASE Intermediate_Dir "rw_case_b___Win32_Debug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "rw_case_b___Win32_Debug"
# PROP Intermediate_Dir "rw_case_b___Win32_Debug"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
...
# Name "rw_case_b - Win32 Release"
# Name "rw_case_b - Win32 Debug"
# Begin Group "SEC Files"

# PROP Default_Filter "sec"
# Begin Source File

SOURCE=.\rw_case_b_scenario.sec

!IF  "$(CFG)" == "rw_case_b - Win32 Release"

# PROP Ignore_Default_Tool 1
# Begin Custom Build - Translate $(InputName).sec ...
InputPath=.\rw_case_b_scenario.sec
InputName=rw_case_b_scenario

"~$(InputName).c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	cl /nologo /W3 /GX /O2 /I "$(CTESK_HOME)\include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "IO_TERM_LOCAL_MAIN" /YX /FD /c /D __SEC__ /I "$(CTESK_HOME)/include" /FI ts/ts.h /E /Tc "./rw_case_b_scenario.sec" > "$(InputName).sei" 
	set R=%ERRORLEVEL% 
...
"~$(InputName).c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	cl /nologo /W3 /Gm /GX /ZI /Od /I "../../.." /I "$(CTESK_HOME)\include" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "IO_TERM_LOCAL_MAIN" /YX /FD /GZ  /c /D __SEC__ /I "$(CTESK_HOME)/include" /FI ts/ts.h /E /Tc "./rw_case_b_scenario.sec" > "$(InputName).sei" 
	set R=%ERRORLEVEL% 
	if _%R%_==_0_ set SEC_PROPERTIES=$(CTESK_HOME)\etc\.sec.vs6.properties 
	if _%R%_==_0_ call "$(CTESK_HOME)\bin\sec-c.bat" "$(InputName).sei" "~$(InputName).c" 
	if _%R%_==_0_ set R=%ERRORLEVEL% 
